...
class DependentController extends Controller
{
    ...
    public function dependentFetch(Request $request)
    {
        ...
        if($dependent =='article_id'){
            ...
            ,'uom.uom_group'
            ,DB::RAW("(select string_agg(concat(unit_to,';',(select unit_factor from uom_con where unit_from =$table.uom and unit_to ='LTR')),',' order by unit_from) as uom_member from uom_con where unit_from = $table.uom)")
            )
            ->get();
