...
/*
    ...
    27-10-2025
    Perubahan metode transfer out yang baru
...
class TransferOutController extends Controller
{
    ...
    public function getTableColoumnDetail()
    {
        ...
        [
            ...
            ['data'=>'note','name'=>'note','title'=>'Note'],
            ['data'=>'status','name'=>'status','title'=>'Status'],
            ['data'=>'location_name_to','name'=>'location_name_to','title'=>'Location From'],
            ['data'=>'location_name_from','name'=>'location_name_from','title'=>'Location To'],
            ['data'=>'approval_by','name'=>'approval_by','title'=>'Approved By'],
    ...
    public function show(Request $request)
    {
        ...
        return view("transfer/transferOut.show",$data);        
    }
    ...
    public function listDetail(Request $request)
    {
        ...
        ->where(function ($query) use ($searchTr,$searchStatus,$trDate,$fromDate,$toDate,$searchType,$transferFrom,$transferTo) {
            ...
            // if($transferFrom){
            //     $transferTo ? $query->orWhere('transfer_det.location_to',$transferTo) : '';
            // }else{
        ...
        ->where('tr_type',$trType)
        ->select('transfer_det.*'
        ,'glm1.location_name as location_name_to'
        ,'glm2.location_name as location_name_from'
        ,'transfer_hdr.*'
    ...
    public function print(Request $request)
    {
        ...
        $pdf = PDF::loadView('transfer.transferOut.print');
