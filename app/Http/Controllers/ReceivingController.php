...
class ReceivingController extends Controller
{
    ...
    public function listDetail(Request $request)
    {
        ...
        ,DB::raw("(price*qty)*(((purchase_order_hdr.dpp_lain_pembilang/purchase_order_hdr.dpp_lain_penyebut)*(purchase_order_hdr.ppn::numeric))/100) as total_ppn")
        ,DB::raw("((price*qty)*(((purchase_order_hdr.dpp_lain_pembilang/purchase_order_hdr.dpp_lain_penyebut)*(purchase_order_hdr.ppn::numeric))/100))+(price*qty) as totaL_plus_ppn")
