    ...
    public function list(Request $request)
    {
        ...
        ->addColumn('action', function ($data) {
            ...
            if ( $data->status == '1' || $data->status == '2') {
                if (Auth::user()->can('transferOut-approve')) {
            ...
            if ( $data->status == '3' ) {
                if (Auth::user()->can('transferOut-posting')) {
                // $buttons .=         '<a href="'. route('transferOut.posting', ['trNumber'=>$data->tr_number]) .'" class="dropdown-item">
            ...
            if ( $data->status == '1' or $data->status == '2' ){
                if (Auth::user()->can('transferOut-edit')) {
                $buttons .=         '<a href="'. route('transferOut.edit', ['id'=>Crypt::encryptString($data->id)]) .'" class="dropdown-item">
                                        <i data-feather="file-text"></i>
                                        <span>'. __("Edit") .'</span>
                                    </a>';
            ...
            if ( $data->status == '4' ){
                if (Auth::user()->can('transferOut-delete')) {
                    $buttons .="<a href='javascript:;'
                    class='dropdown-item' 
                    data-size='sm'
                    data-ajax-delete='true'
