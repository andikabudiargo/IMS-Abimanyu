...
class ActualLoadingExport implements FromView,ShouldAutoSize,WithColumnFormatting,WithEvents
{
    protected $wosNumber;

    function __construct($wosNumber) {
    ...
    public function view(): View
    {
        ...
        //     <td>article_code</td>
        //     <td>article_desc</td>
        //     <td>actual_qty_fresh</td>
        //     <td>actual_qty_repaint</td>
        //     <td>actual_qty_tag</td>
        // </tr>";
        $barisIsiJudul = "<tr >
            <td>No</td>
            <td>wos</td>
        ...
        foreach($headers as $val){
            $woCode = $val->wo_code;
            $articleCode = $val->article_code_1;
            $articleDesc = $val->article_desc;
            $qtyFresh = $val->qty_fresh;
            $qtyRepaint = $val->act_qty_repaint;
            $qtyTag = $val->act_tag;
            $urutan = $val->urutan;
