...
class ArAgingReportExport implements FromArray, WithHeadings, WithStyles, WithTitle, WithColumnFormatting, ShouldAutoSize
{
    protected $rows;
    protected $grand;
    ...
    {
        return 'AR Aging ' . $this->cutoffDate;
    }
