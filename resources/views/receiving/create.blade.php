...
<script type="text/javascript">
        ...
        if (!$("#frmAdd")[0].checkValidity()){
            ...
            $("#article_row input[name='article_id[]']").map(function(i) {  
                ...
                if ($this.val()){
                    ...
                    let qtyFree=objQtyFree.eq(i).val().replace(/[^0-9]/gi, '') || 0;
    ...
    let cloneCount=1;
    function add_new_row(article,articleCode,articleDesc,qtyPo,uomGroup,uom) {
            ...
            success:function(result){
                ...
                if(result.length > 0 ){
                    for (let i = 0; i < result.length; i++) {
                        ...
                        uom=result[i].uom;
                        add_new_row(article,articleCode,articleDesc,qtyPo,uomGroup,uom);
                    }
                }
