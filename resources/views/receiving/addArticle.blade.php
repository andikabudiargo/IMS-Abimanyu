            ...
            <tbody>
                <tr>
                    <td class="isian disabled" style="width: 25%">
                        <input type="text" class="form-control-plaintext text-hitam" id = "article_id" name="article_id[]" data-code="" data-uom="" disabled>
                    </td>
                    ...
                    <td class="isian" style="width: 5%">
                        <input type="text" class="form-control-plaintext numeral-mask-digit text-right" id = "qty_rec" name="qty_rec[]" maxlength="9">
                    </td>
                    <td class="isian" style="width: 5%">
