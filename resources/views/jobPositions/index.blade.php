            ...
            <form class="needs-validation" novalidate>
                ...
                <div class="form-row">
                    <div class="col-12"> 
                        ...
                        <a href="{{ route('jobPosition.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Create</a>
                        @endcan
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
  ...
  $("#btnSearch").click(function(e){
      let code =$("#searchPosCode").val();
      let nama =$("#searchPos").val();
      showList(nama,code);
  });
