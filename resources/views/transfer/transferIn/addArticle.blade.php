    ...
    <div id="baru" class="tanda-baris" >
        <div class="form-row d-flex align-items-center">
            ...
            <div class="col-md-1 col-12">
             ...
             <div class="col-md-2 col-12">
                <div class="form-group margin-nol">
                    <label for="locationTo" class="d-block d-md-none">Location To</label>
                    <select class="form-control" id="locationTo" name="locationTo[]">
                    </select>
                </div>
            </div>
            <div class="col-md-2 col-12">
...
<script type="text/javascript">
    ...
    add_new_row_edit = (article,qty,uom,uomMember,note,locationTo) => {
        ...
        changeselectLocationTo('locationTo'+ cloneCount,locationTo)
    ...
    function add_new_row() {
        if($('#thirdParty').val() !=''){
            ...
            swal.fire('Warning..','Please select supplier/customer first','warning');
        }
    };
    ...
    function changeselectLocationTo(obj,location) {
        $('#'+obj).attr('disabled','disabled');
        $('#'+obj).html(dataLocationTo);
        $('#'+obj).select2();
        $('#'+obj).val(location).trigger('change');
        $('#'+obj).removeAttr('disabled');
    }
    ...
    function isiArticleByThirdParty(dependent,thirdParty) {
    ...
    function disabledEnabledSelect2(){
        let arrValueSelected = $("#article_row select[name='articleId[]']").map(function(){return $(this).val();}).get();
                
        if (arrValueSelected.length > 0){
            thirdParty.attr('disabled','disabled');
        }else{
            thirdParty.removeAttr('disabled');
        }
