                        ...
                        <form id="frmAdd" name="frmAdd" autocomplete="off">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label for="trNumber">Transfer Out Number</label> <small class="text-muted"></small>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" id="locationFrom" name="locationFrom" value="{{ $header->location_name }}" class="form-control" placeholder="DD-MM-YYYY" disabled/>
                                </div>
                            </div>
                            <div class="form-row">
