        ...
        <form class="needs-validation" novalidate>
            <div class="form-row">
              <div class="form-group col-md-3"> 
                <label for="searchDn">DN General Number</label>
            ...
            <div class="form-row">
                <div class="col-12"> 
                    ...
                    <a href="{{ route('dnGeneral.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Create</a>
                    {{-- @endcan --}}
                </div>
            </div>
        </form>
...
<script type="text/javascript">
  ...
  refresh.addEventListener("click",function(){
    ...
    btnSummary.style.display = "none";
    showList(searchDn.value,searchStatus.value,deliveryDate.value,searchCustomer.value);
  })
  ...
  btnDetail.addEventListener("click", function(){
    ...
    btnDetail.style.display = "none";
    showListDetail(searchDn.value,searchStatus.value,deliveryDate.value,searchCustomer.value);
  });

  const showList = (searchDn,searchStatus,deliveryDate,searchCustomer) => {
  ...
  const showListDetail = (searchDn,searchStatus,deliveryDate,searchCustomer) => {
    if ($('#detailedTable tr').length >0){
        let table= $('#detailedTable').DataTable();
        table.destroy();
        $('#detailedTable tbody > tr').remove();
