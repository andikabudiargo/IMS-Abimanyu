...
function setBadge(type) {
    var label = { rm:'Return RM', ot:'Return OT', other:'Other' };
    var color = { rm:'badge-danger', ot:'badge-info', other:'badge-warning' };
    $('#typeBadge')
        .removeClass('badge-danger badge-info badge-warning badge-secondary')
