        ...
        <div class="form-row d-flex align-items-center">
            ...
            <div class="col-md-2 col-12" style="max-width: 15%;">
                <div class="form-group margin-nol">
                    ...
                    {{-- <select class="dynamicSelect form-control" id="salesOrder" name="salesOrder[]" data-dependent="salesOrder" disabled>
                    </select> --}}
                </div>
            </div>
            <div class="col-md-5 col-12">
                <div class="form-group margin-nol">
                    ...
                    <input type="text" class="form-control" id="articleId" name="articleId[]" disabled />
                    {{-- <select class="dynamicSelect form-control" id="articleId" name="articleId[]" data-dependent="articleId" disabled>
                    </select> --}}
...
<script type="text/javascript">
    ...
    function add_new_row_edit(noSo,noArticle,noArticleRm,qtySo,qtySoUom,qtyProd,qtyRepaint,waktu,tag,tagAsli) {
        ...
        $('#waktuAct'+ cloneCountEdit).val(waktuAwal);
        $('#tagAct'+ cloneCountEdit).val(parseFloat(tagAsli)*(parseInt(qtyProd)+parseInt(qtyRepaint)));
        $('#tagAsli'+ cloneCountEdit).val(tagAsli);
        $('#articleRm'+ cloneCountEdit).val(noArticleRm);
        $('#articleId'+ cloneCountEdit).val(noArticle);
