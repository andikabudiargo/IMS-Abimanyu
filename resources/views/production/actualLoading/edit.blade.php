                        ...
                        <form id="frmAdd" name="frmAdd" autocomplete="off">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    {{-- <select class="select2 form-control" id="wosNumber" name="wosNumber" value="{{ $header->prod_code }}" required>
                                        <option value=""></option>
                ...
                <div class="card-body" >
                    ...
                    <div class="form-row">
                        <div class="col-md-12">
                            <div class="form-row">
                                <div class="col-md-12">
                                    <a href="{{ route('production.actualLoading.index') }}" class="btn btn-warning">Back</a>
                                    @if( $approveValidate ? $approveValidate[0]->validate : '')
                                        ...
                                        @endif
                                    @else
                                        @if( !$approveValidate && $statusPrd =='NEW')
                                            <button class="btn btn-primary" type="button" id="cmdSave" name="cmdSave">Update</button>
                                        @endif
                                    @endif
                                </div>
