            ...
            <form class="needs-validation" novalidate>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4"> 
                      ...
                      <select class="select2 w-100" id="searchGroup" name="searchGroup">
                          <option label=""></option>
                    ...
                    <div class="form-group col-md-4"> 
                      ...
                      <select class="select2 w-100" id="searchCustomer" name="searchCustomer">
                          <option label=""></option>
...
<script type="text/javascript">
  ...
  $("#btnSearch").click(function(e){
      ...
      showList(name,code,group,cust);
  });

  function showList(name,code,group,cust){
    ...
    $(function(){
      let oTable =$("#detailedTable").DataTable({
        ...
        columns: [
            ...
            { data: 'desc', name: 'desc',title:'Nama' },
            { data: 'cust', name: 'cust',title:'Customer' },
            { data: 'quality', name: 'quality',title:'Kwalitas' },
            { data: 'group', name: 'group',title:'Group' },
            { data: 'uom', name: 'uom',title:'Satuan' },
