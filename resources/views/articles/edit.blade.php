...
<div class="form-group col-md-2" style="padding-right: 0rem;display: flex;justify-content:flex-start;align-self:flex-end;align-items: center;">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" id="marketingCheck" name="marketingCheck" {{ old("marketingCheck", $article->marketing) ? "checked" : ""}}/>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="select2 form-control" id="coa" name="coa">
                                   ...
                                   @foreach($accounts as $val)
                                                    <option value="{{ $val->account }}" {{ old('coa') == $val->account ? 'selected' : '' }}>{{ $val->account}} - {{ $val->description }}</option>
                                 @endforeach
                                </select>
                            </div>
                        </div>
