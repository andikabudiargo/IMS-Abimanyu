        ...
        <div class="modal-content">
            ...
            <form id="modalReasonRevisionTso" action="" method="post" autocomplete="off">
              ...
              <div class="modal-footer">
                ...
                <button type="button" id="btnRevisionTso" class="btn btn-danger waves-effect">Yes, Revise It <i class="fas fa-spinner fa-spin spinner" id="spinner"></i></button>
              </div>
            </form>
            
            <div class="spinner-overlay" id="overlaySpinner">
...
<div class="modal fade text-left bisa-geser" id="reasonModalRevisionPr" tabindex="-1" role="dialog" aria-hidden="true" >
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h4>Revision<span class="semi-bold"> @yield('title')</span></h4>
          ...
          <form id="modalReasonRevisionPr" action="" method="post" autocomplete="off">
            @csrf
            <div class="modal-body">
              <div class="text-center">
                <i data-feather='alert-circle' class='feather-72-red'></i>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-outline-dark waves-effect" data-dismiss="modal">Cancel</button>
              <button type="button" id="btnRevisionPr" class="btn btn-danger waves-effect">Yes, Revise It <i class="fas fa-spinner fa-spin spinner" id="spinnerPr"></i></button>
            </div>
          </form>
      </div>
  </div>
