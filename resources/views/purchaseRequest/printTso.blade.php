...
<body>
    ...
    <table style="table-layout:fixed;">
        ...
        <tr>
            ...
            @if($colName2 != 'KOSONG')
            <th width="10%">{{ $colName2 }}</th>
            @endif
            <th width="10%">{{ $colName1 }}</th>
            @if($colName2 != 'KOSONG')
        ...
        <tbody>
            @foreach ($details as $val )
                <tr class="border-bottom">
                    ...
                    @if($colName2 != 'KOSONG')
                    <td class="border-bottom" align="right">{{ number_format($val->last_qty,2) }}</td>
                    @endif
                    <td class="border-bottom" align="right">{{ number_format($val->qty,2) }}</td>
                    @if($colName2 != 'KOSONG')
                    <td class="border-bottom" align="right">{{ number_format($val->balance,2) }}</td>
                    @endif
