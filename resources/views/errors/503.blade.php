        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">
                        ...
                        <h2 class="brand-text text-primary ml-1">IMS</h2>
                    </a>
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <img class="img-fluid" src="{{asset('app-assets/images/pages/under-maintenance.svg')}}" alt="Under maintenance page" />
                        </div>
                    </div>
                </div>
                <!-- / Under maintenance-->
