...
<script type="text/javascript">
  ...
  refresh.addEventListener("click",function(){
    ...
    btnSummary.style.display = "none";
    showList(searchWos.value,wosDate.value,searchStatus.value);
  })
  ...
  btnDetail.addEventListener("click", function(){
    ...
    btnDetail.style.display = "none";
    showListDetail(searchWos.value,wosDate.value,searchStatus.value);
  });

  const showList = (searchWos,wosdate,searchStatus) => {
  ...
  const showListDetail = (searchWos,wosdate,searchStatus) => {
    if ($('#detailedTable tr').length >0){
        let table= $('#detailedTable').DataTable();
        table.destroy();
        $('#detailedTable tbody > tr').remove();
