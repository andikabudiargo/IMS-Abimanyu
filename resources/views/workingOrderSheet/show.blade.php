                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <select class="select2 form-control" id="shift" name="shift" disabled>
                                                    ...
                                                    <option value="malam" {{ $header2->wo_shift == 'malam' ? "selected" : "" }} >Malam</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-2">
                                        ...
                                        <div class="table-responsive main-table mt-75">
                                            <table class="table table-bordered w-100" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right" id="sumRemainTime{{ $key }}">{{ number_format($header2->sum_time_required-$header2->sum_available_time) }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
