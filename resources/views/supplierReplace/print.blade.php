...
<head>
    ...
    <style type="text/css">
        ...
        * { font-family: Calibri, Arial, Helvetica, sans-serif; }
        ...
        #tblContent td {
            padding: 0px 10px; border-bottom: none;
            border-left: thin solid var(--line-color);
            border-right: thin solid var(--line-color);
        }
        #tblContent tr:last-child { border-bottom: thin solid var(--line-color); }
                            ...
                            <table style="border-left: thin solid var(--line-color); border-right: thin solid var(--line-color); padding-left:10px" class="font-10 tanpa-padding">
                                ...
                                <tr>
                                    <td width="50%" valign="top">
                                        <table>
                                            <tr>
                                                <td width="20%" valign="top" class="tanpa-padding font-14">Dari</td>
                                    ...
                                    <td width="50%" valign="top">
                                        <table>
                                            ...
                                            <tr>
                                                <td width="30%" valign="top" class="tanpa-padding font-14">Tanggal</td>
                            ...
                            <table id="tblContent" class="font-11">
                                ...
                                <tbody>
                                    @foreach ($details as $val)
                                        <tr>
                                            <td align="center">
                                                <div style="height:25px; display:table-cell; vertical-align:middle; text-align:center;">{{ ++$no }}</div>
                                            </td>
