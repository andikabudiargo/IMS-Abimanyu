                                    ...
                                    <td width="50%" style="vertical-align: bottom;">
                                        ...
                                        <table>
                                            ...
                                            <tr class="tanpa-padding">
                                                ...
                                                <td class="tanpa-padding font-14">Nomor</td>
                                                <td class="tanpa-padding font-14">: {{ $tDnHdr->tdn_number }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table style="border-left: thin solid var(--line-color);border-right: thin solid var(--line-color);padding-left:10px" class="font-13 tanpa-padding">
                                <tr>
                                    <td width="50%" valign="top">
                                        <table>
                                            {{-- <tr>
                                                <td width="25%" class="tanpa-padding">Nomor</td><td class="tanpa-padding">: {{ $tDnHdr->tdn_number }}</td>
                                            </tr> --}}
                                            <tr>
                                                <td width="25%" class="tanpa-padding">Tanggal</td><td class="tanpa-padding">: {{ $tDnHdr->delivery_date }}</td>
                                            </tr>
                                            {{-- <tr>
