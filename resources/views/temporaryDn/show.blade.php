                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            @foreach( $headers as $key =>$header )
                                <li class="nav-item">
                                    ...
                                    data-po-number="{{ $header->tdn_number }}">{{ $key == 0 ? 'Main':'Revision '.($key-1) }}</a>
                                </li>
                            @endforeach
                        </ul>
                            ...
                            @foreach( $headers as $key =>$header2 )
                                <div class="tab-pane {{ $key == 0 ? 'active':'' }}" id="rev{{ $key }}" aria-labelledby="revison{{ $key }}-tab" role="tabpanel">
                                    <form id="frmAdd" name="frmAdd" autocomplete="off">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                <label for="tDnNumber">Request Number</label> <small class="text-muted"> automatic</small>
                                                <input type="text" id="tDnNumber" name="tDnNumber" class="form-control disabled-el" value="{{ $header2->tdn_number }}" disabled />
                                            </div>
                                            <div class="form-group col-md-3">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" id="deliveryDate" name="deliveryDate" class="form-control" placeholder="DD-MM-YYYY" value="{{ $header2->delivery_date }}"required disabled />
                                            </div>
                                        </div>
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                <label class="form-label" for="perihal">Hal</label>
                                                <textarea type="text" id="perihal" name="perihal" class="form-control" rows="1" disabled >{{ $header2->perihal }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                    ...
                                    <div class="table-responsive main-table">
                                        <table class="table table-bordered w-100" id="tableDetail">
                                            ...
                                            @foreach( $details as $item )
                                                @if($item->tdn_number === $header2->tdn_number )
                                                    <tr>
                                    ...
                                    <div class="mt-75">
                                        ...
                                        <a href="{{ route('suratJalanSementara.print',['id'=>Crypt::encryptString($header2->id)]) }}" target="_blank" class="btn btn-success">Print</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
