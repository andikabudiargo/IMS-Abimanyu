        ...
        $(function () {
            ...
            if (soNumber){
                var zTable = $("#detailedArticle").DataTable({              
                    ...
                    autoWidth: false,
                    columns: [
                        { "data": "id","name": "id","title":"#", searchable: false }, //0
                        { "data": "site_name","name": "master_site.site_name","title":"Store" }, //1
                        { "data": "tag","name":"tag","title":"Tag" }, //2
                        { "data": "brand","name":"brand","title":"Brand" }, //3
                        { "data": "count","name":"count","title":"Mem. Count",searchable: false }, //4
                        { "data": "t_12months_plus_val","name":"t_12months_plus_val",render: $.fn.dataTable.render.number(',','.') ,"title":"1 Year+" }, //5
                        { "data": "t_6months_plus_val","name":"t_6months_plus_val",render: $.fn.dataTable.render.number(',','.'),"title":"6-12 Months" }, //6
                        { "data": "t_6months_val","name":"t_6months_val",render: $.fn.dataTable.render.number(',','.'),"title":"2-6 Months" }, //7
                        { "data": "t_last_month_val","name":"t_last_month_val",render: $.fn.dataTable.render.number(',','.'),"title":"Last Month" }, //8
                        { "data": "t_this_month_val","name":"t_this_month_val",render: $.fn.dataTable.render.number(',','.'),"title":"2-4 Weeks" }, //9
                        { "data": "t_this_week_val","name":"t_this_week_val",render: $.fn.dataTable.render.number(',','.'),"title":"This Week" }, //10
                    ], 
                });
            }          
        });
