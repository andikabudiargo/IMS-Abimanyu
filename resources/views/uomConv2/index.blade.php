            ...
            <form class="needs-validation" novalidate>
                ...
                <div class="form-row">
                    <div class="col-12"> 
                        ...
                        <a href="{{ route('uomConv2.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Create</a>
...
<script type="text/javascript">
  ...
  $("#btnSearch").click(function(e){
    ...
    let articleCode = $("#seachCode").val();
    let articleName = $("#searchName").val();
    let supplier = $("#searchSupplier").val();
    let unitFrom = $("#unitFrom").val();
    let unitTo = $("#unitTo").val();

    showList(articleCode, articleName, supplier, unitFrom, unitTo);

});

  function showList(articleCode, articleName, supplier, unitFrom, unitTo)
{
