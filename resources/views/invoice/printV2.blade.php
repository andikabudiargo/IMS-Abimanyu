...
<head>
    ...
    .sheet {
        ...
        margin: 5mm;
        overflow: visible;   /* biar border bawah tabel tidak terpotong saat preview */
    }
}
...
.sub_div_tengah.tengah-full {
    ...
    bottom: 70px;    /* jarak dari dasar; turunkan/naikkan utk atur gap ke "Page 1 of 2" */
        ...
        #tblContent3  td { padding : 0px 10px 0px 10px; }
...
<body class="Letter">
    ...
    <table id="tblContent" class="font-14 {{ $duaHalaman=='yes' ? 'tbl-full' : '' }}" style="table-layout:fixed;">
                ...
                <tbody>
                    ...
                    @endforeach
                    @for ($i = count($details) + 1; $i <= $limitPage1; $i++)
        ...
        @else
            {{-- Masih ada halaman 2: jangan render totals di sini, cukup placeholder + label halaman --}}
            <div class="sub_div2">
                <table>
                    <tr>
                        <td></td>
            ...
            <div class="sub_div_tengah">
                <table id="tblContent" class="font-14" style="table-layout:fixed;">
                    ...
                    <tbody>
                        ...
                        @endforeach
                        @for ($i = count($details2) + 1; $i <= $limitPage2; $i++)
                            <tr style="height:23px">
                                <td ></td>
                                <td ></td>
                                <td ></td>
