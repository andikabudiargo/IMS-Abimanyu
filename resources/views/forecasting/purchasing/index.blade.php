        ...
        <form class="needs-validation" novalidate>
          ...
          <div class="form-row">
              <div class="col-12"> 
                  ...
                  <a href="{{ route('forecastPurchase.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Create</a>
                  {{-- @endcan --}}
              </div>
          </div>
        </form>
...
<script type="text/javascript">
  ...
  $("#btnSearch").click(function(e){
      ...
      if ((parseInt(bulanAkhir)-parseInt(bulanAwal) >= 0) && year){
        ...
        $('#detailedTable thead').append("<tr><td>Action</td><td>supplier</td>"+listJudul+"</tr>");
