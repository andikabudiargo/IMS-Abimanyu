    ...
    <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="totalAmount" name="totalAmount" value="{{ number_format($header->amount,2) }}" class="form-control text-right numeral-mask-digit" maxlength="20" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body" >
                    <div>
                        @include('accounting.jurnalUmum.tableHeader')
                    </div>      
                    ...
                    <div class="form-row">
                        <div class="col-md-12">
                            <a href="{{ route('jurnalUmum.index') }}" class="btn btn-light">Back</a>
                            ...
                            @endif
                            @else
                                @if( (!$approveValidate && $status =='NEW') || $status =='VALIDATED')
                                    <button class="btn btn-primary" type="button" id="cmdUpdate" name="cmdUpdate" >Update</button>
                                @endif
                            @endif
                        </div>
...
@include('accounting.jurnalUmum.addArticle')
@endsection
@section('styles')
...
<script type="text/javascript">
    ...
    function getAmountValue(vRef,objIndex) {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('jurnalUmum.get.invoice.amount') }}",
            data: {
                vRef:vRef
            },
            dataType: "json",
