                        ...
                        <form id="frmAdd" name="frmAdd"  method="post" autocomplete="off">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="select2 form-control" id="apType" name="apType" required>
                                                <option value="PO" {{ $header->ap_type != 'NONPO' ? 'selected' : '' }}>PO</option>
                                                <option value="NONPO" {{ $header->ap_type == 'NONPO' ? 'selected' : '' }}>Non-PO</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-8">
                                            ...
                                            <select class="select2 form-control" id="supplier" name="supplier" required>
                                                ...
                                                @foreach($supps as $val)
                                                    <option value="{{ $val->kode }}" data-term = "{{ $val->top_batas_1 }}" data-coa = "{{ $val->account }}" data-coa-desc="{{ $val->account_desc }}"  {{ old('supplier',$header->supplier_id) == $val->kode ? 'selected' : '' }} >{{$val->kode}} - {{$val->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-7">
                                            ...
                                            <input type="text" id="accountHutang" class="form-control disabled-el" value="{{ old('accountHutang',$header->account_total) }}{{ $header->account_total_desc ? ' - '.$header->account_total_desc : '' }}" disabled />
                                            <input type="hidden" id="accountHutangCode" name="accountHutang" value="{{ old('accountHutang',$header->account_total) }}" />
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="dueDate">Due Date</label>
                                            <input type="text" id="dueDate" name="dueDate" class="form-control" value="{{ old('dueDate',$header->due_date) }}" placeholder="DD-MM-YYYY" />
                                        </div>
                                        <div class="form-group col-md-2">
                            ...
                            <div class="d-flex justify-content-between align-items-end mt-75">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row mb-03">
                                        <label for="totalPPH42" class="col-sm-4 col-form-label titik-dua">WHT 4(2) <span id="nilaiPPH42">{{ $header->pph23_type == 'PPH42' ? $nilaiPPH42."%" : '' }}</span> </label>
                                        <div class="col-sm-1" style="padding-right: 0rem;display: flex;align-items: center;">
                                            <div class="custom-control custom-checkbox">
