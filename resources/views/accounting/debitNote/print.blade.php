                        ...
                        <table width="100%">
                            <tr>
                                <td width="65%" align="center" style="border: 1px solid #0c0c0c;padding-left:5px;padding-right:5px" >
                                    <h2 style="margin:0px">DEBIT NOTE</h2>
                                </td>
                ...
                <tbody>
                    @foreach ($details as $val )
                        ...
                        @endif
                            ...
                            <td  style="border-right: 1px solid black;" align="left">{{ $val->article_code }}</td>
                ...
                <table id="tblContent2" style="table-layout:fixed;">
                    <tbody>
                        @foreach ($totals as $val )   
                            <tr style="height:25px">
                                <td width="59%" colspan="4" rowspan="6" style="border-bottom: 1px solid black;">
