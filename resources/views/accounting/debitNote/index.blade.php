        ...
        <form class="needs-validation" novalidate>
            <div class="form-row">
              <div class="form-group col-md-3"> 
                <label for="searchDn">DN Number</label>
            ...
            <div class="form-row">
                <div class="col-12"> 
                    ...
                    {{-- @can('receiving-create') --}}
                      <a href="{{ route('debitNote.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Create</a>
                    {{-- @endcan --}}
                </div>
            </div>
        </form>
...
<script type="text/javascript">
  ...
  $("#btnSearch").click(function(e){
    ...
    showList(searchDn,searchCustomer,searchStatus,dnDate);
