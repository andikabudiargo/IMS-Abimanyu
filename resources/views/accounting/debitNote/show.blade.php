                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" id="invNumber" name="invNumber" value="{{ $header->dn_number }}" class="form-control text-hitam disabled-el"  disabled />
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="invDate">Invoice Date*</label>
                                            <input type="text" id="invDate" name="invDate" value="{{ $header->dn_date }}" class="form-control" placeholder="DD-MM-YYYY"  disabled />
                                        </div>                               
                                    </div>
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="poNumber" disabled>PO Number*</label>
                                            <input type="text" id="poNumber" name="poNumber" value="{{ $header->po_number }}" class="form-control" disabled />
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
