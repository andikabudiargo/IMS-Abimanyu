            ...
            <form class="needs-validation" novalidate>
                <div class="form-row">
                    <div class="col-md-4"> 
                        ...
                        <label for="searchGroupCode">Kode</label>
                        <input type="text" class="form-control text-uppercase" id="searchGroupCode" name="searchGroupCode" placeholder=""  />
                        </div>
                    </div>
                    <div class="col-md-4"> 
                    <div class="form-group">
                        <label for="searchGroup">Nama</label>
                        <input type="text" class="form-control text-uppercase" id="searchGroup" name="searchGroup" placeholder="" />
                    </div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-12"> 
                        ...
                        @can('groupMaterial-create')
                        <a href="{{ route('groupMaterial.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> Create</a>
                        @endcan
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
  ...
  $("#btnSearch").click(function(e){
      let code =$("#searchGroupCode").val();
      let nama =$("#searchGroup").val();
      showList(nama,code);
  });
